/*
 * List that holds all cards <listOfCards>
 */
...
// check when the first card is opened
...
// create and append animated card
 createCard=(card)=> {
...
// disable clicking on the open Cards
disableCLick=()=> {
    openCards.forEach(function (card) {
        card.off('click');
    });
}
// enable click on open card
enableClick=()=> {
    openCards[0].click(toggleCard);
}
// check if openCards match or not
matchOpenCards=()=> {
